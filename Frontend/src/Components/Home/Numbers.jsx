    ...
    return (
        <section className="py-20 relative">
            <div className="max-w-5xl mx-auto px-4 relative z-10">
                <h2 className="geist-mono-latin-700 text-3xl sm:text-4xl md:text-5xl font-bold text-center text-neutral-200 mb-12" style={{ transform: "translateY(20px)" }}>TypeFast by
